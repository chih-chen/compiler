...
public MyLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("funcao", this), new Integer(22));
	literals.put(new ANTLRHashString("real", this), new Integer(11));
	literals.put(new ANTLRHashString("texto", this), new Integer(12));
	literals.put(new ANTLRHashString("inteiro", this), new Integer(10));
	literals.put(new ANTLRHashString("fim", this), new Integer(15));
	literals.put(new ANTLRHashString("declare", this), new Integer(6));
	literals.put(new ANTLRHashString("fimprog", this), new Integer(5));
	literals.put(new ANTLRHashString("inicio", this), new Integer(14));
}
...
tryAgain:
	...
	public final void mNUMINT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = NUMINT;
		int _saveIndex;
	...
	public final void mNUMPF(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = NUMPF;
		int _saveIndex;
	...
	public final void mABRECHAVE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = ABRECHAVE;
		int _saveIndex;
	...
	public final void mFECHACHAVE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		int _ttype; Token _token=null; int _begin=text.length();
		_ttype = FECHACHAVE;
		int _saveIndex;
	...
	private static final long[] mk_tokenSet_1() {
		long[] data = { 287948918354870272L, 576460745995190270L, 0L, 0L};
		return data;
	}
